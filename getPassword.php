...
if($choix == "changePassword") {
	...
	<tr class=titre><td align=center colspan=2><?php echo _s("Demande de nouveau mot de passe");?> :</td></tr>
	<?php if($sNiveau == "patient" && getSrOption("passwordPerso") == 0) { ?>
		<tr class=corpsFonce><td colspan=2 style="font-size:11px;"><?php echo _s("Votre mot de passe a expir");?>.</td></tr>
	<?php } ?>
		<tr class=corpsFonce><td colspan=2 style="font-size:11px;"><?php echo _s("Veuillez saisir vos identifiant et adresse e-mail avec lesquels vous tes identifs auprs du laboratoire. Si vous n'avez pas ces informations, merci de contacter le laboratoire.");?></td></tr>
		<tr><td align=right><?php echo _s("Identifiant");?> : </td><td><input type="text" value="" name="sLogin" autocomplete="off" ></td></tr>
		<tr><td align=right><?php echo _s("Adresse e-mail");?> : </td><td><input type="text" value="" name="sMail" autocomplete="off" ></td></tr>
		<tr><td align="center" colspan=2><input type="submit" name="send" value="<?php echo _s("Demander un nouveau mot de passe");?>"></td></tr>
<?php
	}
}
